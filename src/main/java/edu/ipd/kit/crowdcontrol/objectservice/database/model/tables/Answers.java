...
public class Answers extends org.jooq.impl.TableImpl<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.AnswersRecord> {
	...
	private static final long serialVersionUID = 572776910;
	 ...
	 */
	public final org.jooq.TableField<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.AnswersRecord, java.lang.Integer> TASK = createField("task", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>crowdcontrol.Answers.answer</code>.
	 */
	public final org.jooq.TableField<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.AnswersRecord, java.lang.String> ANSWER = createField("answer", org.jooq.impl.SQLDataType.CLOB.length(16777215).nullable(false), this, "");
