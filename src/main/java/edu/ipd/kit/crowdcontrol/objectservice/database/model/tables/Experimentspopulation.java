...
public class Experimentspopulation extends org.jooq.impl.TableImpl<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.ExperimentspopulationRecord> {
	...
	private static final long serialVersionUID = 441459073;
	 ...
	 */
	public final org.jooq.TableField<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.ExperimentspopulationRecord, java.lang.Integer> IDEXPERIMENTSPOPULATION = createField("idExperimentsPopulation", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
	 ...
	 */
	public final org.jooq.TableField<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.ExperimentspopulationRecord, java.lang.Integer> REFERENCED_POPULATION = createField("referenced_population", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>crowdcontrol.ExperimentsPopulation.referenced_platform</code>.
	 */
	public final org.jooq.TableField<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.ExperimentspopulationRecord, java.lang.Integer> REFERENCED_PLATFORM = createField("referenced_platform", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
	...
	public java.util.List<org.jooq.ForeignKey<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.ExperimentspopulationRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.ExperimentspopulationRecord, ?>>asList(edu.ipd.kit.crowdcontrol.objectservice.database.model.Keys.POPULATIONUSER, edu.ipd.kit.crowdcontrol.objectservice.database.model.Keys.REFERENCEDPOPULATION, edu.ipd.kit.crowdcontrol.objectservice.database.model.Keys.REFERENCEDPLATFORM);
	}
