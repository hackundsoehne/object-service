...
public class ExperimentspopulationDao extends org.jooq.impl.DAOImpl<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.records.ExperimentspopulationRecord, edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.pojos.Experimentspopulation, java.lang.Integer> {
	 ...
	 */
	@Override
	protected java.lang.Integer getId(edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.pojos.Experimentspopulation object) {
	 ...
	 */
	public java.util.List<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.pojos.Experimentspopulation> fetchByIdexperimentspopulation(java.lang.Integer... values) {
	 ...
	 */
	public edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.pojos.Experimentspopulation fetchOneByIdexperimentspopulation(java.lang.Integer value) {
	 ...
	 */
	public java.util.List<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.pojos.Experimentspopulation> fetchByReferencedPopulation(java.lang.Integer... values) {
		return fetch(edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.Experimentspopulation.EXPERIMENTSPOPULATION.REFERENCED_POPULATION, values);
	}

	/**
	 * Fetch records that have <code>referenced_platform IN (values)</code>
	 */
	public java.util.List<edu.ipd.kit.crowdcontrol.objectservice.database.model.tables.pojos.Experimentspopulation> fetchByReferencedPlatform(java.lang.Integer... values) {
