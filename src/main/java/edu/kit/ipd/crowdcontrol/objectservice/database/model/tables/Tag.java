...
public class Tag extends org.jooq.impl.TableImpl<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.records.TagRecord> {
    ...
    private static final long serialVersionUID = -253027001;
     ...
     */
    public final org.jooq.TableField<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.records.TagRecord, java.lang.Integer> ID_TAG = createField("id_tag", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>crowdcontrol.Tag.tag</code>.
     */
    public final org.jooq.TableField<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.records.TagRecord, java.lang.String> TAG_ = createField("tag", org.jooq.impl.SQLDataType.VARCHAR.length(191).nullable(false), this, "");
     ...
     */
    @Override
    public org.jooq.Identity<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.records.TagRecord, java.lang.Integer> getIdentity() {
        return edu.kit.ipd.crowdcontrol.objectservice.database.model.Keys.IDENTITY_TAG;
    }
