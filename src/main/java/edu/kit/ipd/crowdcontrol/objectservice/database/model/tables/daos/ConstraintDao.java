...
import edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.Constraint;
...
public class ConstraintDao extends org.jooq.impl.DAOImpl<ConstraintRecord, Constraint, java.lang.Integer> {
	...
	public ConstraintDao() {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Constraint.CONSTRAINT, Constraint.class);
	}
	...
	public ConstraintDao(org.jooq.Configuration configuration) {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Constraint.CONSTRAINT, Constraint.class, configuration);
	}
	...
	public java.util.List<Constraint> fetchByIdconstraint(java.lang.Integer... values) {
		return fetch(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Constraint.CONSTRAINT.IDCONSTRAINT, values);
	}
	...
	public Constraint fetchOneByIdconstraint(java.lang.Integer value) {
		return fetchOne(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Constraint.CONSTRAINT.IDCONSTRAINT, value);
	}
