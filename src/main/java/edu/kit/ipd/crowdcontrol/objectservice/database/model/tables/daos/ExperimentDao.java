...
import edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.Experiment;
...
public class ExperimentDao extends org.jooq.impl.DAOImpl<ExperimentRecord, Experiment, java.lang.Integer> {
	...
	public ExperimentDao() {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Experiment.EXPERIMENT, Experiment.class);
	}
	...
	public ExperimentDao(org.jooq.Configuration configuration) {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Experiment.EXPERIMENT, Experiment.class, configuration);
	}
	...
	public java.util.List<Experiment> fetchByAnswerDescription(java.lang.String... values) {
		return fetch(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Experiment.EXPERIMENT.ANSWER_DESCRIPTION, values);
	}
	...
	public java.util.List<Experiment> fetchByAnswertype(java.lang.String... values) {
		return fetch(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Experiment.EXPERIMENT.ANSWERTYPE, values);
	}
}
