...
public class ExperimentsCalibrationDao extends org.jooq.impl.DAOImpl<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.records.ExperimentsCalibrationRecord, edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.ExperimentsCalibration, java.lang.Integer> {
	 ...
	 */
	public java.util.List<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.ExperimentsCalibration> fetchByReferncedExperiment(java.lang.Integer... values) {
		return fetch(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.ExperimentsCalibration.EXPERIMENTS_CALIBRATION.REFERNCED_EXPERIMENT, values);
	}
	 ...
	 */
	public java.util.List<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.ExperimentsCalibration> fetchByReferencedPlatform(java.lang.String... values) {
		return fetch(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.ExperimentsCalibration.EXPERIMENTS_CALIBRATION.REFERENCED_PLATFORM, values);
	}
