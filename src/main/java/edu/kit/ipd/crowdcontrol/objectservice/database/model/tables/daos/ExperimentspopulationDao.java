...
import edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.Experimentspopulation;
...
public class ExperimentspopulationDao extends org.jooq.impl.DAOImpl<ExperimentspopulationRecord, Experimentspopulation, java.lang.String> {
	...
	public ExperimentspopulationDao() {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Experimentspopulation.EXPERIMENTSPOPULATION, Experimentspopulation.class);
	}
	...
	public ExperimentspopulationDao(org.jooq.Configuration configuration) {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Experimentspopulation.EXPERIMENTSPOPULATION, Experimentspopulation.class, configuration);
	}
	 ...
	 */
	public java.util.List<Experimentspopulation> fetchByCorrectAnswer(java.lang.Integer... values) {
		return fetch(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Experimentspopulation.EXPERIMENTSPOPULATION.CORRECT_ANSWER, values);
	}
