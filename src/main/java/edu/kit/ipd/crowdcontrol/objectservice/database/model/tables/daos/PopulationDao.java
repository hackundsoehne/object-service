...
import edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.Population;
...
public class PopulationDao extends org.jooq.impl.DAOImpl<PopulationRecord, Population, java.lang.Integer> {
	...
	public PopulationDao() {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Population.POPULATION, Population.class);
	}
	...
	public PopulationDao(org.jooq.Configuration configuration) {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Population.POPULATION, Population.class, configuration);
	}
	...
	public java.util.List<Population> fetchByIdpopulation(java.lang.Integer... values) {
		return fetch(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Population.POPULATION.IDPOPULATION, values);
	}
	...
	public Population fetchOneByIdpopulation(java.lang.Integer value) {
		return fetchOne(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Population.POPULATION.IDPOPULATION, value);
	}
