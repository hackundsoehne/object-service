...
import edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.pojos.Tag;
...
public class TagDao extends org.jooq.impl.DAOImpl<TagRecord, Tag, java.lang.Integer> {
	 ...
	 */
	public TagDao() {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Tag.TAG, Tag.class);
	}
	...
	public TagDao(org.jooq.Configuration configuration) {
		super(edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.Tag.TAG, Tag.class, configuration);
	}
