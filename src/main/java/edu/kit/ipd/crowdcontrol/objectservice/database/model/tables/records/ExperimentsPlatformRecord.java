...
public class ExperimentsPlatformRecord extends UpdatableRecordImpl<ExperimentsPlatformRecord> implements Record4<Integer, Integer, String, JsonElement> {

	private static final long serialVersionUID = 709535495;
	 ...
	 */
	@Override
	public Row4<Integer, Integer, String, JsonElement> fieldsRow() {
	 ...
	 */
	@Override
	public Row4<Integer, Integer, String, JsonElement> valuesRow() {
	 ...
	 */
	@Override
	public ExperimentsPlatformRecord values(Integer value1, Integer value2, String value3, JsonElement value4) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ExperimentsPlatformRecord(Integer idexperimentsPlatforms, Integer experiment, String platform, JsonElement platformData) {
		super(ExperimentsPlatform.EXPERIMENTS_PLATFORM);
