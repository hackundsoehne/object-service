...
-- -----------------------------------------------------
-- Table `crowdcontrol`.`Rating_Constraints`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Rating_Constraints` (
  `id_rating_Constraints` INT NOT NULL,
