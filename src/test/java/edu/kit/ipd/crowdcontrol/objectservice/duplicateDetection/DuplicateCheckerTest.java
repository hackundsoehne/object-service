...
public class DuplicateCheckerTest {
    ...
    public void setUp() throws Exception {
        ...
        doAnswer(new Answer() {
            ...
            public Object answer(InvocationOnMock invocation) throws Throwable {
                ...
                answerResponseMap.put(answerRecord.getIdAnswer(),answerRecord.getSystemResponse());
                if(!answerHashMap.containsValue(answerRecord.getHash())) {
                    answerHashMap.put(answerRecord, answerRecord.getHash());
                    System.out.println(answerRecord.getIdAnswer()+"Setting "+answerRecord.getAnswer());

                }
                answerQualityMap.put(answerRecord.getIdAnswer(),answerRecord.getQuality());
                return null;
            }
    ...
    public void testCheckExperimentForDuplicates() throws Exception {
        ...
        uniqueAnswer.setQualityAssured(false);
    ...
    public void testImageDuplicateDetection() throws Exception {
        ...
        assertEquals(answerHashMap.size(),2);
